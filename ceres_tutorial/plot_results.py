...
parser.add_option("--initial_poses", dest="initial_poses",
                  default="./build/poses_original.txt", help="The filename that contains the original poses.")
parser.add_option("--optimized_poses", dest="optimized_poses",
                  default="./build/poses_optimized.txt", help="The filename that contains the optimized poses.")
