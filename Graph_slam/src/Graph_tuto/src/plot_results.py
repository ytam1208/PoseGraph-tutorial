...
parser.add_option("--initial_poses", dest="initial_poses",
                  default="/home/cona/git/Graph-SLAM/Graph_slam/poses_original.txt", help="The filename that contains the original poses."),
parser.add_option("--observation_poses", dest="observation_poses",
                  default="/home/cona/git/Graph-SLAM/Graph_slam/poses_observation.txt", help="The filename that contains the observation poses.")
parser.add_option("--optimized_poses", dest="optimized_poses",
                 default="/home/cona/git/Graph-SLAM/Graph_slam/poses_optimized.txt", help="The filename that contains the optimized poses.")
