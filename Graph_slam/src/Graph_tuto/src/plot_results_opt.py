...
parser.add_option("--initial_poses", dest="optimized_initial_poses",
                  default="/home/cona/git/Graph-SLAM/Graph_slam/poses_optimized_ref.txt", help="The filename that contains the original poses."),
parser.add_option("--observation_poses", dest="optimized_observation_poses",
                  default="/home/cona/git/Graph-SLAM/Graph_slam/poses_optimized_obs.txt", help="The filename that contains the observation poses.")
